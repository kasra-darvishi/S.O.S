...
public class PoliceClustering extends StaticClustering {
    ...
    public Map<EntityID, EntityID> centerMap;
    ...
    public PoliceClustering(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
        ...
        this.clusterSize = developData.getInteger("sample.module.SampleKMeans.clusterSize", worldInfo.getEntitiesOfType(StandardEntityURN.POLICE_FORCE).size());
        ...
        centerMap = new LazyMap<EntityID, EntityID>() {
            @Override
            public EntityID createValue() {
                return null;
            }
        };
    ...
    public List<EntityID> getCenterIDs(){
        return centerIDs;
    }
